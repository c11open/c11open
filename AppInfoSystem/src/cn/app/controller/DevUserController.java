...
public class DevUserController {
	...
	public String appinfolist(HttpServletRequest request,
		...
		request.setAttribute("queryFlatformId", Integer.parseInt(queryFlatformId));
		info.setCategoryLevel1(Integer.parseInt(queryCategoryLevel1));
		request.setAttribute("queryCategoryLevel1", Integer.parseInt(queryCategoryLevel1));
		info.setCategoryLevel2(Integer.parseInt(queryCategoryLevel2));
	/*	request.setAttribute("queryCategoryLevel2", Integer.parseInt(queryCategoryLevel2));*/
		info.setCategoryLevel3(Integer.parseInt(queryCategoryLevel3));
		/*request.setAttribute("queryCategoryLevel3", Integer.parseInt(queryCategoryLevel3));*/
		map.put("Info", info);		
